...
from score.itf.plugins.targets.qemu.process import QemuProcess

from score.itf.plugins.capabilities.ssh.ssh import Ssh
from score.itf.plugins.capabilities.ssh.sftp import Sftp
from score.itf.plugins.capabilities.ping.ping import ping, ping_lost
...
def qemu_target(test_config):
    ...
    with (
        ...
        target = QemuRuntime(qemu_process, test_config.qemu_config)
        yield target
